...
//	  idx++;
	  if(send_flag==1){
		  ...
		  //	  HAL_UART_Transmit(&huart1, (int16_t *)pwm_buffer, sizeof(pwm_buffer), HAL_MAX_DELAY);
	  }
//	  pwm = PID_Calculation(200, motor_p.rpm);
